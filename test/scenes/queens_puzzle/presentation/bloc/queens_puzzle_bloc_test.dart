...
class MockGetStoredBoardSolutions extends Mock implements GetStoredBoardSolutions {}

main() {
  QueensPuzzleBloc bloc;
  MockGetBoardSolutions mockGetBoardSolutions;
  MockGetStoredBoardSolutions mockGetStoredBoardSolutions;

  setUp(() {
    mockGetBoardSolutions = MockGetBoardSolutions();
    mockGetStoredBoardSolutions = MockGetStoredBoardSolutions();
    bloc = QueensPuzzleBloc(mockGetBoardSolutions, mockGetStoredBoardSolutions);
  });
